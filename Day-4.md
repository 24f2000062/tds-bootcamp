...
--- Before Day-4 ---
I already knew some basic web concepts and had heard about APIs, but I did not clearly understand HTTP methods, status codes, or how API requests work internally.
---
...
--- After Day-4 ---
I learned how APIs communicate over HTTP, how requests and responses are structured, and how FastAPI can be used to quickly build and test backend endpoints.
---

--- Feedback (Suggestions for the TDS Team) ---
The practical API testing exercises and FastAPI examples made backend concepts much easier to understand.
---
...
Personal Notes:
Need more practice with HTTP status codes, FastAPI routing, and using `curl` commands efficiently.
